...
const WhySection = ({ 
  ...
  return (
    <div id={id} className="mb-20 max-w-4xl mx-auto">
      ...
      <h2 className="text-2xl md:text-3xl font-bold text-primary">{title.replace(/Krtrim/g, 'Krtrim')}</h2>
      </div>
      <div className="text-foreground/80 space-y-4">
      {typeof content === 'string'
        ? content.replace(/Krtrim/g, 'Krtrim')
        : content}
      </div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="mt-10 glass-panel p-8 md:p-10 rounded-lg max-w-3xl mx-auto shadow-lg border-2 border-primary/20">
            <p className="text-xl md:text-2xl text-foreground/90">
              Why should Krtrim exist? Why should anyone care to use it? Why is privacy so important to us?
            </p>
        ...
        <WhySection
          ...
          content={
            <>
              ...
              <p>
                With Krtrim we ultimately asked ourselves, why not? Why not find a different way to save what we care about? Why not remove all the other stuff that just gets in the way? Forget how it's usually done. Why not make it better?
              </p>
              <div className="mt-6">
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                <p className="font-medium">The beginning — How did we end up creating Krtrim?</p>
          ...
          content={
            <>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                ...
                <p className="mt-2 font-medium">A thought from Krtrim on social features﻿</p>
        ...
        <WhySection
          ...
          content={
            <>
              <p>
                We built Krtrim for doers and makers. For people who are busy doing other things and simply need a place to collect and remember what they care about.
              </p>
              <p>
                Krtrim doesn't interfere, doesn't bother and doesn't ask to be maintained. It's meant to serve you, as an extension of your mind. So you can think about anything and everything except the tool itself.
              </p>
              <p>
                Because that's all it is: A tool meant to help you achieve something else. Those who like to procrastinate with folders and unmaintainable systems will find plenty of other apps to keep them busy. Krtrim is for those who would rather draw and write and build and dance and sing.
              </p>
            </>
          }
        />
