  ...
  return (
    <>
      <SEO 
        ...
        description="Learn about Krtrim's proven process for delivering successful AI and web development projects. From consultation to build and support, we ensure a transparent and collaborative journey."
        keywords="AI development process, web development workflow, agile development, project consultation, client support"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
          ...
          <div className="mb-24 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-foreground/80 mb-6 text-center">
              At Krtrim, we deliver AI-powered solutions and expert development tailored to your business needs. Our expertise spans Web Development, AI Solutions, and full-stack SaaS development, helping you automate processes, enhance customer experience, and drive growth.
            </p>
            <ul className="list-disc list-inside text-foreground/80 mb-6">
              <li>Custom Web Development for a strong online presence</li>
              <li>AI Solutions (Chat & Voice) for seamless, human-like conversations</li>
              <li>Full-Stack SaaS Development for scalable software applications</li>
            </ul>
