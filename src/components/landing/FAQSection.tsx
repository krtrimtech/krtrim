...
export const FAQSection = ({
  ...
  const faqs = [{
    ...
    id: "item-2",
    question: "How does Krtrim differ from regular note-taking apps?",
    answer: "Unlike traditional note-taking apps, Krtrim uses AI to automatically connect related concepts, visualize knowledge networks, and surface relevant information when you need it. It's designed to mimic how your brain naturally connects ideas."
  }, {
    id: "item-3",
    ...
    answer: "Absolutely! Krtrim supports importing from popular tools like Notion, Evernote, Roam Research, and more. Our import process preserves your existing structure while enhancing it with AI-powered connections."
  }, {
    id: "item-5",
